 ...
 */
export function murmur3_32(data: string | Uint8Array, seed: number = 0): number {
 ...
 */
export function murmur3_32_hex(data: string | Uint8Array, seed: number = 0): string {
 ...
 */
export function murmur3_128(data: string | Uint8Array, seed: number = 0): string {
