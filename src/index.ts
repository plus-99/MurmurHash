...
export class MurmurHash {
   ...
   */
  static hash2_32(data: string | Uint8Array, seed: number = 0): number {
   ...
   */
  static hash2_32Hex(data: string | Uint8Array, seed: number = 0): string {
   ...
   */
  static hash2_64(data: string | Uint8Array, seed: number = 0): string {
