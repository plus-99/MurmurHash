(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MurmurHash = {}));
     ...
     */
    function murmur2_32(data, seed = 0) {
        const bytes = typeof data === 'string' ? stringToUtf8Bytes(data) : data;
        const len = bytes.length;
        const m = 0x5bd1e995;
        const r = 24;
     ...
     */
    function murmur2_32_hex(data, seed = 0) {
     ...
     */
    function murmur2_64(data, seed = 0) {
        const bytes = typeof data === 'string' ? stringToUtf8Bytes(data) : data;
        const len = bytes.length;
    ...
    exports.murmur2_32 = murmur2_32;
    exports.murmur2_32_hex = murmur2_32_hex;
    exports.murmur2_64 = murmur2_64;
